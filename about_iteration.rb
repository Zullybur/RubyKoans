...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # ANSWER:
    # Injects a value in to the accumulator variable prior to starting the
    # for-each iteration through the array. All subsequent opeartions are
    # performed on the accumulator as per the code block
  end
