...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # A: Perhaps when searching a nil string
  end
  ...
  #
  # Why?
  # A: Because they search for an include in the result as many sequantial
  #    iterations of the specified character as they can.
  ...
  # A:  Character Class: Any of the listed characters are acceptable in the indicated position
  #     Alternation: Match one or more possible complete expressions.
