...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # ANSWER:
    # __send__ is newer, now send can be overwritten!
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # ANSWER:
    # It will allow us to handle messages passed to an object that
    # may contain invalid method names (e.g. dynamically created
